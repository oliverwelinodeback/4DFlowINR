...
def downsample_complex_img(complex_img, crop_ratio, targetSNR, hamming):
...
def downsample_phase_img(velocity_img, mag_image, venc, crop_ratio, targetSNR, hamming=False):
    ...
    # -----------------------------------------------------------
    new_complex_img, shifted_freqmag = downsample_complex_img(complex_img, crop_ratio, targetSNR, hamming)
    # -----------------------------------------------------------

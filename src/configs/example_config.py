...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    config.data_file = "../example_data/example_LR.h5"
    ...
    config.network_name = "inr_example"
    ...
    config.wandb.group = "inr-example"
    config.wandb.tags = ["inr", "example"]
    ...
    config.visualization.time_index_lr = 6
    config.visualization.z_index_lr = 10

...
def get_config(sweep_config=None):
    ...
    # Data
    config.data_file = "../data/00182655-HNCM_V150.h5"
    config.include_ref = True
    config.data_file_ref = "../data/00182655-HNCM_V150.h5"
    ...
    networks_folder = "../models/260226_2_00182655_HNCM_V150_sys_fs1_0"

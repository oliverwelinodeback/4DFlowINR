...
def get_sweep_config():
    ...
    return {
        'name': f'NS_Tunings_128FEATsweep_{timestamp}', 
        'method': 'grid',
...
def get_config(sweep_config=None):
    ...
    # Model 
    config.networks_folder = "../models/251016_NS_WIRE_REAL_128feat_4000collpoints/"
    config.network_name = "HV01_WIRE_momentum_128feat_8000collpoints" 
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')
    ...
    config.training.data_points_per_batch = 8_000 # None to use all #20000
    config.training.coll_points_per_batch = 8_000 # None to use all #20000

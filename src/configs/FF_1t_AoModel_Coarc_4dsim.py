...
def get_config(sweep_config=None):
    ...
    config.constants.venc = 4.0 # m/s

    # Data
    config.data_file = f"../data/Simulation_Coarctation/res_1_0/AoCoarc_res_1_0_noisy_4dsim_2mm_VENC{int(config.constants.venc*100)}_n2.h5"
    ...
    # Model 
    networks_folder = f"../models/260506_Aomodel_Coarc_res_1_0_4dsim_V{int(config.constants.venc*100)}_n2_108ffn_e5000"
    ...
    config.resolution.dx = 0.001 # m
    config.resolution.dy = 0.001 # m
    config.resolution.dz = 0.001 # m
    config.resolution.dt = 0.0121654 # s
    ...
    config.collocation_points = 65_000
    ...
    config.training.lr_decay_iter = 850
    ...
    config.training.physics_weight = 0.5

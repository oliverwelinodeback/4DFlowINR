...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    config.data_file = "../data/Simulation_healthy/AoHealthy_noisy_2mm_VENC70_n14.h5"
    ...
    # Model 
    networks_folder = "../models/251212_Aomodel_nosim_V70_n14_FINAL"

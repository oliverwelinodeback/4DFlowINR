...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    config.data_file = "../data/Simulation_healthy/AoHealthy_noisy_4dsim_2mm_VENC250_n2.h5"
    ...
    # Model 
    networks_folder = "../models/260211_Aomodel_4dsim_V250_n2_dilation"
    ...
    config.resolution.dx = 0.002 # m
    config.resolution.dy = 0.002 # m
    config.resolution.dz = 0.002 # m
    config.resolution.dt = 0.01874 # s

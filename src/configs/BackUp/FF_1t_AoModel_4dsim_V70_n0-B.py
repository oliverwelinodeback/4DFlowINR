...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    config.data_file = "../data/Simulation_healthy/AoHealthy_noisy_4dsim_2mm_VENC70_n0.h5"
    ...
    # Model 
    networks_folder = "../models/251113_Aomodel_4dsim_V70_n0_opt"
    config.network_name = networks_folder.split("/")[-1] + '_FFN_1t-sys-opt'
    ...
    # Fourier Feature Encoding scale
    config.network.fourier_scale = 1.0

    # Training parameters
    config.training = ml_collections.ConfigDict()
    config.training.iterations = 3_500 # 300000

...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    config.data_file = "../data/Simulation_healthy/AoHealthy_noisy_4dsim_2mm_VENC100_n0.h5"
    ...
    # Model 
    networks_folder = "../models/250708_Aomodel_4dsim_V100_n0_f"
    config.network_name = networks_folder.split("/")[-1] + '_FFN_1t-sys-Sept1'
    ...
    config.training.iterations = 2_500 # 300000

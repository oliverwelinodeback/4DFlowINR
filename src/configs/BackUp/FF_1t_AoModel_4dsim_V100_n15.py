...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    config.data_file = "../data/Simulation_healthy/AoHealthy_noisy_4dsim_2mm_VENC100_n15.h5"
    ...
    # Model 
    networks_folder = "../models/260211_Aomodel_4dsim_V100_n15_FINAL"

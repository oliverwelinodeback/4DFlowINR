...
def get_sweep_config():
    ...
    return {
        'name': f'WIRE_MOMENTUM_SV_GridPlot_HV01_{timestamp}', 
        'method': 'grid',
...
def get_config(sweep_config=None):
    ...
    # Model 
    config.networks_folder = "../models/251209_WIRE_MOMENTUM_HV01_GridPlot/"
    config.network_name = "251209_WIRE_MOMENTUM_HV01_GridPlot" 
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')

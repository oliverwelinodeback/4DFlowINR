...
def get_config(sweep_config=None):
    ...
    config.network_name = "260130_MetaLearn_PINN"
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')
    ...
    config.meta_learning.inner_lr = 0.00014
    config.meta_learning.inner_steps = 5
    config.meta_learning.inner_points = 3000       # Max data points per inner step
    ...
    config.meta_learning.outer_lr = 0.00003
    ...
    config.meta_learning.use_physics_loss = True   # Enable Navier-Stokes in inner loop
    ...
    config.meta_learning.use_grad_weights = True  # Enable gradient-based loss balancing

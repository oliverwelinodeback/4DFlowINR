...
def get_config(sweep_config=None):
    ...
    # Model
    config.networks_folder = "../models/MetaLearning_Reptile_DataDriven/"
    config.network_name = "260202_Reptile_DataDriven"
    ...
    # Outer loop settings (Adam optimizer - but Reptile uses manual update)
    config.meta_learning.outer_lr = 0.0001
    config.meta_learning.meta_batch_size = 4  # Memory efficient like FOMAML

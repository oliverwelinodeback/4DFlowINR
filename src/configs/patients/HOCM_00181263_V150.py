...
def get_config(sweep_config=None):
    ...
    # Data
    config.data_file = "../data/00181263-HOCM_V150.h5"
    config.include_ref = True
    config.data_file_ref = "../data/00181263-HOCM_V150.h5"
    ...
    networks_folder = "../models/250709_2_00181263_HOCM_V150_all_timeframes_fs18"

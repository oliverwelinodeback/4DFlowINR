...
def get_config(sweep_config=None):
    ...
    # Data
    config.data_file = "../data/00173032-HOCM_V50.h5"
    config.include_ref = True
    config.data_file_ref = "../data/00173032-HOCM_V50.h5"
    ...
    networks_folder = "../models/250213_00173032_HOCM_V50_all_timeframes_fs18"
    config.network_name = "FFN_1t_HOCM_V50_f2"

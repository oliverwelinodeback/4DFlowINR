...
def get_config(sweep_config=None):
    ...
    # Data
    config.data_file = "../data/00100833-HNCM_V450.h5"
    config.include_ref = True
    config.data_file_ref = "../data/00100833-HNCM_V450.h5"
    config.ref_spatial_factor = 1
    config.ref_temporal_factor = 1

    # Model 
    networks_folder = "../models/2503110_00100833_HNCM_V450_all_timeframes_fs18"
    # networks_folder = "../models/250213_00173032_HOCM_V150_all_timeframes_fs200"
    config.network_name = "FFN_1t_HNCM_V450_f2"

...
def get_config(sweep_config=None):
    ...
    # Data
    config.data_file = "../data/00183103-HNCM_V150.h5"
    config.include_ref = True
    config.data_file_ref = "../data/00183103-HNCM_V150.h5"
    ...
    networks_folder = "../models/250709_2_00183103_HNCM_V150_all_timeframes_fs18"
    ...
    config.domain.x_end = 162
    config.domain.y_start = 0
    config.domain.y_end = 162
    config.domain.z_start = 0
    config.domain.z_end = 41

...
def get_sweep_config():
    ...
    return {
        'name': f'WIRE-COMPLEX_maskTest_{timestamp}', 
        'method': 'grid',
        ...
        'parameters': {
            ...
            'data_file': {'values': [
                ...
                "../data/stenosis_70/ICAD21_05mm3_20ms_LR_dv_hv26_tSNR8_newMask.h5",
                "../data/stenosis_70/ICAD21_05mm3_20ms_sv26_tSNR10.h5", 
                "../data/stenosis_70/ICAD21_05mm3_20ms_sv26_tSNR10_newMask.h5", 
...
def get_config():
    ...
    # Model 
    config.networks_folder = "../models/251031_WIRE_CMPLX_ICAD21_maskTest/"
    config.network_name = "ICAD21_WIRE_CMPLX_maskTest" 
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')

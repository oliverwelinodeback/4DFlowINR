...
def get_sweep_config():
    ...
    return {
        'name': f'WIRE_MOMENTUM_ALL_{timestamp}', 
        'method': 'grid',
...
def get_config(sweep_config=None):
    ...
    # Model 
    config.networks_folder = "../models/251031_WIRE_MOMENTUM_ALL/"
    config.network_name = "251031_WIRE_MOMENTUM_ALL" 
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')
    ...
    config.training.iterations = 15000 #15000 #!#

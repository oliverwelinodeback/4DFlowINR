...
def get_config():
    ...
    # Model 
    config.networks_folder = "../models/251031_WIRE_DIVERGENCE_HV01/"
    config.network_name = "251031_WIRE_DIVERGENCE_HV01" 
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')
    ...
    config.training.data_points_per_batch = 10_000 # None to use all
    config.training.coll_points_per_batch = 10_000 # None to use all

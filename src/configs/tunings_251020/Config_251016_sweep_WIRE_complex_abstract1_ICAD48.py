...
def get_sweep_config():
    ...
    return {
        'name': f'WIRE-COMPLEX_abstract1_ICAD48_{timestamp}', 
        'method': 'grid',
        'metric': {'name': 'FINAL Relative Error [Fluid]', 'goal': 'minimize'},
        'parameters': {
            'data_file': {'values': ["../data/stenosis_50/ICAD48_05mm3_20ms_LR_dv_hv13_tSNR8.h5"]},
        },
    }
...
def get_config():
    ...
    # Data
    config.data_file = "../data/stenosis_50/ICAD48_05mm3_20ms_LR_dv_hv13_tSNR8.h5" #### CTNUE ERHEHREHRHEHRE
    ...
    # Model 
    config.networks_folder = "../models/251020_WIRE_CMPLX_abstract1_ICAD48/"
    config.network_name = "ICAD248WIRE_CMPLX" 
    timestamp = datetime.now().strftime('%Y%m%d-%H%M')

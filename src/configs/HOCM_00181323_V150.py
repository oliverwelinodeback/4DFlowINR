...
def get_config(sweep_config=None):
    ...
    # Data
    config.data_file = "../data/00181323-HOCM_V150.h5"
    config.include_ref = True
    config.data_file_ref = "../data/00181323-HOCM_V150.h5"
    ...
    # networks_folder = "../models/250709_2_00181323_HOCM_V150_all_timeframes_fs18"
    networks_folder = "../models/260224_2_00181323_HOCM_V150_sys_fs4_3"
    # networks_folder = "../models/DEBUG"
    config.network_name = networks_folder.split("/")[-1] 
    ...
    config.network.fourier_scale = 4.3

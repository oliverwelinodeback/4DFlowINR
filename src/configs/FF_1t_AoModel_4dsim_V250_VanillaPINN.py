...
def get_config(sweep_config=None):
    ...
    # config.constants.U = 3.0
    # config.constants.L = 0.01
    config.constants.T = 0.005
    config.constants.rho = 1060
    config.constants.mu = 0.004
    #######################################################
    config.constants.venc = 2.5  # CAMBIAR CUANDO SE CAMBIA DE VENC
    #######################################################
    # Data
    config.data_file = f"../data/Simulation_healthy/AoHealthy_noisy_4dsim_2mm_VENC{int(config.constants.venc*100)}_n6.h5"
    # config.data_file = f"../data/Simulation_Coarctation/res_1_0/AoCoarc_res_1_0_noisy_4dsim_2mm_VENC{int(config.constants.venc*100)}_n6.h5"
    config.include_ref = True
    config.data_file_ref = "../data/Simulation_healthy/AoHealthy_ref_2mm.h5"
    # config.data_file_ref = "../data/Simulation_Coarctation/res_1_0/AoCoarc_res_1_0_ref_2mm.h5"
    config.ref_spatial_factor = 1
    config.ref_temporal_factor = 1
    # Model 
    networks_folder = f"../models/260522_Aomodel_Healthy_4dsim_V{int(config.constants.venc*100)}_n6_VanillaPINN_NOFF_2_nobound"
    # networks_folder = f"../models/260522_Aomodel_Coarc_4dsim_V{int(config.constants.venc*100)}_n6_VanillaPINN_NOFF"
    ...
    # config.domain.t_start = 0
    # config.domain.t_end = 24
    # config.domain.x_start = 0
    # config.domain.x_end = 60
    # config.domain.y_start = 0
    # config.domain.y_end = 27
    # config.domain.z_start = 0
    # config.domain.z_end = 40
    ...
    config.network.hidden_features = 60
    ...
    # config.network.fourier_scale = 1.08
    ...
    config.training.lr_decay_iter = 2500
    ...
    config.training.physics_weight = 0.04

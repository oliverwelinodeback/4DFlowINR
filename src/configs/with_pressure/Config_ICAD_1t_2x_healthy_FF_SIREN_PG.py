...
def get_config(sweep_config=None):
    ...
    config.network_name = "Config_ICAD_1t_2x_healthy_FF_SIREN_PG" 
    ...
    config.training.iterations = 40000
    config.training.data_points_per_batch = None # None to use all #20000
    config.training.coll_points_per_batch = 20000 # None to use all #20000
    config.training.boundary_points_per_batch = None # None to use all #10000
    # Optimizer
    ...
    config.training.iterations_before_BFGS = 38000
    # Loss details
    ...
    config.training.use_vector_potential = False # tune

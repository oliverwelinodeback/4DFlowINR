...
def get_config(sweep_config=None):
    ...
    config.sweep = False
    # Data
    # config.data_file = "../data/Simulation_healthy/AoHealthy_noisy_4dsim_2mm_VENC250_n6.h5"
    ...
    # Model 
    # networks_folder = "../models/260430_Aomodel_Healthy_4dsim_V250_n6_SIREN_withtime_e1k_Orig_SEGEXP"
    networks_folder = f"../models/260504_Aomodel_Coarc_4dsim_V{int(config.constants.venc*100)}_n2_SIREN_withtime_e1k_SEGEXP"
    config.network_name = networks_folder.split("/")[-1] + '_SIREN'
    ...
    config.collocation_points = 100_000
    ...
    config.training.data_points_per_batch = 150_000 # None to use all

...
def get_config(sweep_config=None):
    ...
    # Model 
    networks_folder = "../models/250531_PINN_PG_test" ## Change this
    config.network_name = "Config_1x_HV01_highSNR_PG_BFGS_check" 
    ...
    config.resolution.dt = 0.01 ### 0.0826
    ...
    config.training.iterations_before_BFGS = 100 
    # Loss details

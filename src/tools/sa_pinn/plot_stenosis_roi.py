...
#   2. Run: python src/tools/plot_stenosis_roi.py
...
#
# Run from 4DFlowINR/:  python src/tools/plot_stenosis_roi.py
# ---------------------------------------------------------------------------
import os
import sys
...
from utils.prepare_data import prepare_data, prepare_ref_data

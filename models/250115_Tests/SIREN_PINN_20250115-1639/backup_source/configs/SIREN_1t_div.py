...
def get_config():
    ...
    config.network_name = "SIREN_1t_div"
    ...
    config.training.use_LBFGS = True ##TF
    config.training.BFGS_lr = 1e-1
    config.training.iterations_before_BFGS = 4800
    # Loss details
    config.training.epochs_before_PDE = 0
    config.training.grad_weight_scheme = False ##TF
    config.training.alpha = 0.9
    # Data loss options
    ...
    config.training.use_boundary_mse = True ##TF

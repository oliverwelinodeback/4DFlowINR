...
from utils.evaluation_utils import create_boundary_and_core_masks, calculate_relative_error, calculate_absolute_error, calculate_rmse, calculate_absolute_error_pressure, calculate_rmse_pressure, linreg
...
from utils.utils import copy_cource_code, save_checkpoint, sample_to_device, plot_predictions, evaluate_predictions, plot_predictions_vs_reference, set_seed, save_to_h5, h5_to_paraview
...
if __name__ == "__main__":
    ...
    network_path = "../models/250106/SIREN_test_20250106-1427/SIREN_test_final.pth"
    results_directory = "../results/250106/SIREN_test_20250106-1427_2"

...
def get_config():
    ...
    # Data
    config.data_file = "../../data/data_05mm_incl_pressure/healthy-05mm3_LR_dv_241211.h5"
    ...
    # Model 
    networks_folder = "../models/2501015_Tests"
    config.network_name = "SIREN_x2"
    ...
    config.domain.x_start = int(120/2)
    config.domain.x_end = int(200/2)
    config.domain.y_start = 0
    config.domain.y_end = int(56/2)
    config.domain.z_start = int(20/2)
    config.domain.z_end = int(70/2)
    ...
    config.training.iterations = 2000 # 300000
    ...
    config.plot.gt = True
    config.plot.t_step = 80
    config.plot.z_slice = int(20/2)
    ...
    config.predictions.peak_flow_idx = 34
